import type { FrameGraph, FrameGraphTextureHandle, Scene, Camera, FrameGraphObjectList, FrameGraphRenderContext, ObjectRendererOptions, Nullable, Observer, FrameGraphShadowGeneratorTask, FrameGraphRenderPass, AbstractEngine, SmartArray, SubMesh } from "@babylonjs/core";
import { FrameGraphTaskMultiRenderTarget } from "@babylonjs/core/FrameGraph/frameGraphTaskMultiRenderTarget.js";
import { ObjectRenderer } from "@babylonjs/core/Rendering/objectRenderer.js";
import { ThinDepthPeelingRenderer } from "@babylonjs/core/Rendering/thinDepthPeelingRenderer.js";
import { FrameGraphRenderTarget } from "@babylonjs/core/FrameGraph/frameGraphRenderTarget.js";
/**
