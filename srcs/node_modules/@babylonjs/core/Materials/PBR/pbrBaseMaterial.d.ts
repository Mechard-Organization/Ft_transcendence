...
import { PBRBRDFConfiguration } from "@babylonjs/core/Materials/PBR/pbrBRDFConfiguration.js";
import { PrePassConfiguration } from "@babylonjs/core/Materials/prePassConfiguration.js";
...
import { PBRIridescenceConfiguration } from "@babylonjs/core/Materials/PBR/pbrIridescenceConfiguration.js";
import { PBRAnisotropicConfiguration } from "@babylonjs/core/Materials/PBR/pbrAnisotropicConfiguration.js";
import { PBRSheenConfiguration } from "@babylonjs/core/Materials/PBR/pbrSheenConfiguration.js";
import { PBRSubSurfaceConfiguration } from "@babylonjs/core/Materials/PBR/pbrSubSurfaceConfiguration.js";
import { DetailMapConfiguration } from "@babylonjs/core/Materials/material.detailMapConfiguration.js";
declare const PBRMaterialDefinesBase_base: {
    new (...args: any[]): {
        MAINUV1: boolean;
        MAINUV2: boolean;
        MAINUV3: boolean;
...
declare class PBRMaterialDefinesBase extends PBRMaterialDefinesBase_base {
}
declare const PBRMaterialDefines_base: {
    new (...args: any[]): {
 ...
 * @internal
 */
export declare class PBRMaterialDefines extends PBRMaterialDefines_base {
    PBR: boolean;
    NUM_SAMPLES: string;
...
declare const PBRBaseMaterialBase_base: {
    new (...args: any[]): {
        ...
        _imageProcessingObserver: Nullable<import("@babylonjs/core").Observer<ImageProcessingConfiguration>>;
 ...
 */
export declare abstract class PBRBaseMaterial extends PBRBaseMaterialBase {
    /**
