...
} from "./chunk-AYK5BUV7.js";
import {
  AbstractMesh
} from "./chunk-VOLOM45C.js";
import "./chunk-BKD4PRAL.js";
import "./chunk-IFADKFQN.js";
import "./chunk-76LUTIF5.js";
import {
  KeyboardEventTypes
} from "./chunk-YO3VSBWT.js";
import {
  PointerEventTypes
} from "./chunk-3EJSGTYW.js";
import "./chunk-AIYSKJ45.js";
import "./chunk-WKXRXUEO.js";
import "./chunk-K2B5QV3K.js";
import "./chunk-I4YIQPFW.js";
import "./chunk-KUK4PGEW.js";
import {
  PerfCounter
} from "./chunk-LJSODA3L.js";
import "./chunk-WAGTS43G.js";
import "./chunk-42YOKTEN.js";
import {
  Viewport
} from "./chunk-NDQU2K5N.js";
import "./chunk-2PJUNA7K.js";
import "./chunk-I2PO3XEU.js";
import {
  Texture
} from "./chunk-DRCLJCCK.js";
import "./chunk-I3JFIEQG.js";
import {
  SerializationHelper
...
var ColorPicker = class _ColorPicker extends Control {
  ...
  set value(value) {
    ...
    this.onValueChangedObservable.notifyObservers(this._value, void 0, this, this);
  }
  /**
   * Gets or sets control width
   * @see https://doc.babylonjs.com/features/featuresDeepDive/gui/gui#position-and-size
...
var Line = class _Line extends Control {
  ...
  set connectedControl(value) {
    if (this._connectedControl === value || value instanceof _Line && value._connectedControl === this) {
      return;
    }
...
var VirtualKeyboard = class _VirtualKeyboard extends StackPanel {
  ...
  static CreateDefaultLayout(name) {
    const returnValue = new _VirtualKeyboard(name);
...
var AdvancedDynamicTexture = class _AdvancedDynamicTexture extends DynamicTexture {
  ...
  _getGlobalViewport() {
    ...
    const scale = this._adjustToEngineHardwareScalingLevel ? this._renderScale / (((_a = this.getScene()) == null ? void 0 : _a.getEngine().getHardwareScalingLevel()) || 1) : 1;
  ...
  static CreateFullscreenUI(name, foreground = true, sceneOrOptions = null, sampling = Texture.BILINEAR_SAMPLINGMODE, adaptiveScaling = false) {
    ...
    const result = isScene ? new _AdvancedDynamicTexture(name, 0, 0, sceneOrOptions, false, sampling) : new _AdvancedDynamicTexture(name, sceneOrOptions);
...
var FrameGraphGUITask = class extends FrameGraphTask {
  ...
  constructor(name, frameGraph, adt) {
    ...
    if (adt) {
      ...
      adt = AdvancedDynamicTexture.CreateFullscreenUI(name, void 0, { useStandalone: true });
    }
    this._adt = adt;
...
var NodeRenderGraphGUIBlock = class extends NodeRenderGraphBlock {
  ...
  _buildBlock(state) {
    ...
    this._frameGraphTask.targetTexture = (_a = this.target.connectedPoint) == null ? void 0 : _a.value;
  }
};
