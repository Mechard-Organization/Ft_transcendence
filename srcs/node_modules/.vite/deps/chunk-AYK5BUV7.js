...
var FrameGraphPass = class {
  ...
  _initialize() {
    var _a;
    (_a = this._initFunc) == null ? void 0 : _a.call(this, this._context);
  }
  /** @internal */
  _isValid() {
...
var FrameGraphRenderPass = class extends FrameGraphPass {
  ...
  _dispose() {
    var _a;
    (_a = this._frameGraphRenderTarget) == null ? void 0 : _a.dispose();
  }
};
...
var FrameGraphTask = class {
  ...
  _execute() {
    ...
    if (!this._disableDebugMarkers) {
      (_b = (_a = this._frameGraph.engine)._debugPushGroup) == null ? void 0 : _b.call(_a, `${this.getClassName()} (${this.name})`);
    }
    for (const pass of passes) {
      pass._execute();
    }
    if (!this._disableDebugMarkers) {
      (_d = (_c = this._frameGraph.engine)._debugPopGroup) == null ? void 0 : _d.call(_c);
    }
    ...
    if (this._previousDefines !== defines) {
      ...
      this._drawWrapper.effect = engine.createEffect("layer", [VertexBuffer.PositionKind], ["textureMatrix", "color", "scale", "offset"], ["textureSampler"], defines, void 0, void 0, void 0, void 0, this._shaderLanguage, this._shadersLoaded ? void 0 : async () => {
        if (this._shaderLanguage === 1) {
          await Promise.all([import("./layer.vertex-XWQDWYL2.js"), import("./layer.fragment-YNY4E6J7.js")]);
        } else {
          await Promise.all([import("./layer.vertex-LLN34TDV.js"), import("./layer.fragment-RC2DIHMW.js")]);
        }
...
//# sourceMappingURL=chunk-AYK5BUV7.js.map
