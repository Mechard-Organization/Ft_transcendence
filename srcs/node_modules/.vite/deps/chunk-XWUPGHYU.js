import {
  ...
  RenderingManager,
  SmartArray
} from "./chunk-7NKITCZP.js";
import {
  EffectWrapper
} from "./chunk-EES3KXQJ.js";
import {
  PerfCounter
...
import {
  BaseTexture,
  Texture
} from "./chunk-DRCLJCCK.js";
import {
  SerializationHelper
} from "./chunk-APED6DTF.js";
import {
  __decorate,
  serialize,
  serializeAsColor4
} from "./chunk-V2J4XOJT.js";
import {
  AbstractEngine,
  Effect,
  FloorPOT,
...
var RenderTargetTexture = class _RenderTargetTexture extends Texture {
  ...
  constructor(name, size, scene, generateMipMaps = false, doNotChangeAspectRatio = true, type = 0, isCube = false, samplingMode = Texture.TRILINEAR_SAMPLINGMODE, generateDepthBuffer = true, generateStencilBuffer = false, isMulti = false, format = 5, delayAllocation = false, samples, creationFlags, noColorAttachment = false, useSRGBBuffer = false) {
    ...
    this._onBeforeRenderingManagerRenderObserver = this._objectRenderer.onBeforeRenderingManagerRenderObservable.add(() => {
      ...
      (_a = engine._debugPushGroup) == null ? void 0 : _a.call(engine, `Render to ${this.name} (face #${this._currentFaceIndex} layer #${this._currentLayer})`);
    });
    this._onAfterRenderingManagerRenderObserver = this._objectRenderer.onAfterRenderingManagerRenderObservable.add(() => {
      var _a, _b;
      (_a = engine._debugPopGroup) == null ? void 0 : _a.call(engine);
      if (!this._disableEngineStages) {
  ...
  isReadyForRendering() {
    if (!this._dumpToolsLoading) {
      ...
      import("./dumpTools-U6M3UMBE.js").then((module) => this._dumpTools = module);
    }
...
var PostProcess = class _PostProcess {
  ...
  _gatherImports(useWebGPU = false, list) {
    if (useWebGPU && this._webGPUReady) {
      list.push(Promise.all([import("./postprocess.vertex-PNJXMRL3.js")]));
    } else {
      list.push(Promise.all([import("./postprocess.vertex-UP7UBUNF.js")]));
    }
  }
  /**
...
function _GetCompatibleTextureLoader(extension, mimeType) {
  ...
  if (!RegisteredTextureLoaders.has(extension)) {
    if (extension.endsWith(".ies")) {
      registerTextureLoader(".ies", async () => await import("./iesTextureLoader-6P7TSRQU.js").then((module) => new module._IESTextureLoader()));
    }
    if (extension.endsWith(".dds")) {
      registerTextureLoader(".dds", async () => await import("./ddsTextureLoader-OZ2WQILA.js").then((module) => new module._DDSTextureLoader()));
    }
    if (extension.endsWith(".basis")) {
      registerTextureLoader(".basis", async () => await import("./basisTextureLoader-2LJ3LBO7.js").then((module) => new module._BasisTextureLoader()));
    }
    if (extension.endsWith(".env")) {
      registerTextureLoader(".env", async () => await import("./envTextureLoader-W6KKSG35.js").then((module) => new module._ENVTextureLoader()));
    }
    if (extension.endsWith(".hdr")) {
      registerTextureLoader(".hdr", async () => await import("./hdrTextureLoader-GEIJHRHX.js").then((module) => new module._HDRTextureLoader()));
    }
    if (extension.endsWith(".ktx") || extension.endsWith(".ktx2")) {
      registerTextureLoader(".ktx", async () => await import("./ktxTextureLoader-3ZINVPN7.js").then((module) => new module._KTXTextureLoader()));
      registerTextureLoader(".ktx2", async () => await import("./ktxTextureLoader-3ZINVPN7.js").then((module) => new module._KTXTextureLoader()));
    }
    if (extension.endsWith(".tga")) {
      registerTextureLoader(".tga", async () => await import("./tgaTextureLoader-TDSSCFPK.js").then((module) => new module._TGATextureLoader()));
    }
    if (extension.endsWith(".exr")) {
      registerTextureLoader(".exr", async () => await import("./exrTextureLoader-X5ZA7FQM.js").then((module) => new module._ExrTextureLoader()));
    }
  }
...
ThinEngine.prototype.createPrefilteredCubeTexture = function(rootUrl, scene, lodScale, lodOffset, onLoad = null, onError = null, format, forcedExtension = null, createPolynomials = true) {
  const callbackAsync = async (loadData) => {
    ...
    const { DDSTools } = await import("./dds-4D7DRIP7.js");
    const textures = [];
...
var ThinPassPostProcess = class _ThinPassPostProcess extends EffectWrapper {
  _gatherImports(useWebGPU, list) {
    if (useWebGPU) {
      ...
      list.push(Promise.all([import("./pass.fragment-U5IUDOPF.js")]));
    } else {
      list.push(Promise.all([import("./pass.fragment-MUXJMDWK.js")]));
    }
...
var ThinPassCubePostProcess = class _ThinPassCubePostProcess extends EffectWrapper {
  _gatherImports(useWebGPU, list) {
    if (useWebGPU) {
      this._webGPUReady = true;
      list.push(Promise.all([import("./passCube.fragment-GDTFHSDY.js")]));
    } else {
      list.push(Promise.all([import("./passCube.fragment-TH7CNANW.js")]));
    }
    super._gatherImports(useWebGPU, list);
  }
  /**
...
async function WhenTextureReadyAsync(texture) {
  ...
  if (texture.loadingError) {
    throw new Error(((_a = texture.errorObject) == null ? void 0 : _a.message) || `Texture ${texture.name} errored while loading.`);
  }
  const onLoadObservable = texture.onLoadObservable;
  if (onLoadObservable) {
    return await new Promise((res) => onLoadObservable.addOnce(() => res()));
  }
  const onLoadedObservable = (_b = texture._texture) == null ? void 0 : _b.onLoadedObservable;
...
async function ReadPixelsUsingRTT(texture, width, height, face, lod) {
  ...
  if (!engine.isWebGPU) {
    if (texture.isCube) {
      await import("./lodCube.fragment-KQULHTIJ.js");
    } else {
      await import("./lod.fragment-325FYCJV.js");
    }
  } else {
    if (texture.isCube) {
      await import("./lodCube.fragment-PRRGAED7.js");
    } else {
      await import("./lod.fragment-LY4N6U3B.js");
    }
  }
  let lodPostProcess;
  if (!texture.isCube) {
...
//# sourceMappingURL=chunk-XWUPGHYU.js.map
