...
async function _CreateDumpResourcesAsync() {
  var _a;
  const canvas = ((_a = EngineStore.LastCreatedEngine) == null ? void 0 : _a.createCanvas(100, 100)) ?? new OffscreenCanvas(100, 100);
  if (canvas instanceof OffscreenCanvas) {
    Logger.Warn("DumpData: OffscreenCanvas will be used for dumping data. This may result in lossy alpha values.");
  }
  const { ThinEngine: thinEngineClass } = await import("./thinEngine-DWWV2IZX.js");
  ...
  const { passPixelShader } = await import("./pass.fragment-MUXJMDWK.js");
...
function Dispose() {
  ...
  ResourcesPromise == null ? void 0 : ResourcesPromise.then((resources) => {
...
//# sourceMappingURL=chunk-MBEF3MQQ.js.map
