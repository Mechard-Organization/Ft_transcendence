...
var Tools = class {
  ...
  static set PerformanceLogLevel(level) {
    ...
    if ((level & _a.PerformanceUserMarkLogLevel) === _a.PerformanceUserMarkLogLevel) {
      if (_native == null ? void 0 : _native.enablePerformanceLogging) {
    ...
    (_a2 = _native == null ? void 0 : _native.disablePerformanceLogging) == null ? void 0 : _a2.call(_native);
  }
  // eslint-disable-next-line @typescript-eslint/no-unused-vars
  ...
  static _StartMarkNative(counterName, condition = true) {
    if (condition && (_native == null ? void 0 : _native.startPerformanceCounter)) {
  ...
  static _EndMarkNative(counterName, condition = true) {
    if (condition && (_native == null ? void 0 : _native.endPerformanceCounter)) {
...
//# sourceMappingURL=chunk-VN4MOBH6.js.map
