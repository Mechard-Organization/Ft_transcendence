...
var Scene = class _Scene {
  ...
  get _eyePosition() {
    var _a;
    return this._forcedViewPosition ?? ((_a = this.activeCamera) == null ? void 0 : _a.globalPosition) ?? Vector3.ZeroReadOnly;
  }
  /**
  ...
  constructor(engine, options) {
    ...
    if (engine.getCreationOptions().useLargeWorldRendering || (options == null ? void 0 : options.useFloatingOrigin)) {
      OverrideMatrixFunctions();
  ...
  _renderForCamera(camera, rigParent, bindFrameBuffer = true) {
    ...
    if (this.renderTargetsEnabled) {
      ...
      if (this._renderTargets.length > 0) {
        ...
        const boundingBoxRenderer = (_a = this.getBoundingBoxRenderer) == null ? void 0 : _a.call(this);
    ...
    this._engine.currentRenderPassId = ((_b = camera.outputRenderTarget) == null ? void 0 : _b.renderPassId) ?? camera.renderPassId ?? 0;
...
//# sourceMappingURL=chunk-Z5KK3KFW.js.map
