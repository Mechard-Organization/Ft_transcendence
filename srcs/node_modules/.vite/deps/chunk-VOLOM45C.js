import {
  Node
} from "./chunk-BKD4PRAL.js";
import {
  extractMinAndMax,
  extractMinAndMaxIndexed
} from "./chunk-76LUTIF5.js";
import {
  PickingInfo
...
var AbstractMesh = class _AbstractMesh extends TransformNode {
  ...
  updateFacetData() {
    ...
    const normals = (_a = this.getVerticesData(VertexBuffer.NormalKind)) == null ? void 0 : _a.slice();
  ...
  async optimizeIndicesAsync() {
    ...
    const { OptimizeIndices } = await import("./mesh.vertexData.functions-5FJQVBPJ.js");
...
//# sourceMappingURL=chunk-VOLOM45C.js.map
