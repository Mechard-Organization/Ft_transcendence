...
function SetClipPlane(effect, uniformName, clipPlane) {
  var _a;
  if (clipPlane) {
    const offset = ((_a = FloatingOriginCurrentScene.getScene()) == null ? void 0 : _a.floatingOriginOffset) || Vector3.ZeroReadOnly;
...
function PrepareDefinesForMisc(mesh, scene, useLogarithmicDepth, pointsCloud, fogEnabled, alphaTest, defines, applyDecalAfterDetail = false, useVertexPulling = false, renderingMesh, setVertexOutputInvariant) {
  ...
  if (defines._areMiscDirty) {
    ...
    const indexBuffer = (_a = renderingMesh == null ? void 0 : renderingMesh.geometry) == null ? void 0 : _a.getIndexBuffer();
...
//# sourceMappingURL=chunk-IFADKFQN.js.map
