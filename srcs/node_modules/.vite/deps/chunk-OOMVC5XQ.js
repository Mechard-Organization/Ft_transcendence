import {
  Scene
} from "./chunk-Z5KK3KFW.js";
import {
  DumpDataAsync
} from "./chunk-MBEF3MQQ.js";
import {
  CubeMapToSphericalPolynomialTools
} from "./chunk-PDM63653.js";
import {
  ApplyPostProcess,
  PostProcess,
  SphericalPolynomial
...
var RGBDTextureTools = class {
  ...
  static ExpandRGBDTexture(texture) {
    ...
    const expandRgbdTextureAsync = async () => {
      ...
      internalTexture.isReady = false;
      if (isWebGpu) {
        await import("./rgbdDecode.fragment-JIL4QAGD.js");
      } else {
        await import("./rgbdDecode.fragment-MSC2MSZU.js");
      }
  ...
  static async EncodeTextureToRGBD(internalTexture, scene, outputTextureType = 0) {
    if (!scene.getEngine().isWebGPU) {
      await import("./rgbdEncode.fragment-3MCLZBP7.js");
    } else {
      await import("./rgbdEncode.fragment-WDTUW3QZ.js");
    }
...
async function CreateEnvTextureAsync(texture, options = {}) {
  ...
  if (irradianceTexture) {
    ...
    info.irradiance.irradianceTexture = {
      ...
      faces: [],
      dominantDirection: (_b = irradianceTexture._dominantDirection) == null ? void 0 : _b.asArray()
    };
    for (let face = 0; face < 6; face++) {
...
function UploadEnvLevelsAsync(texture, data, info) {
  ...
  if (irradianceTexture) {
    ...
    if ((_c = (_b = info.irradiance) == null ? void 0 : _b.irradianceTexture) == null ? void 0 : _c.dominantDirection) {
...
//# sourceMappingURL=chunk-OOMVC5XQ.js.map
