...
var _WebAudioStaticSound = class __WebAudioStaticSound extends StaticSound {
  ...
  async cloneAsync(options = null) {
    const clone = await this.engine.createSoundAsync(this.name, (options == null ? void 0 : options.cloneBuffer) ? this.buffer.clone() : this.buffer, this._options);
    clone.outBus = (options == null ? void 0 : options.outBus) ? options.outBus : this.outBus;
    return clone;
  }
  /** @internal */
  dispose() {
...
var _WebAudioStaticSoundBuffer = class __WebAudioStaticSoundBuffer extends StaticSoundBuffer {
  ...
  clone(options = null) {
    ...
    buffer.name = (options == null ? void 0 : options.name) ? options.name : this.name;
    return buffer;
  }
...
var _WebAudioStaticSoundInstance = class extends _StaticSoundInstance {
  ...
  dispose() {
    var _a, _b;
    super.dispose();
    (_a = this._pitch) == null ? void 0 : _a.dispose();
    (_b = this._playbackRate) == null ? void 0 : _b.dispose();
    this._sourceNode = null;
    this.stop();
    this._deinitSourceNode();
    this.engine.stateChangedObservable.removeCallback(this._onEngineStateChanged);
  ...
  set currentTime(value) {
    ...
    if (restart) {
      ...
      this._deinitSourceNode();
      sourceNode == null ? void 0 : sourceNode.stop();
      this._state = 1;
    }
    if (this.state === 5) {
      this._enginePauseTime = 0;
  ...
  set pitch(value) {
    var _a;
    (_a = this._pitch) == null ? void 0 : _a.setTargetValue(value);
  }
  /** @internal */
  set playbackRate(value) {
    var _a;
    (_a = this._playbackRate) == null ? void 0 : _a.setTargetValue(value);
  }
  /** @internal */
  get startTime() {
    if (this._state === 1) {
...
//# sourceMappingURL=chunk-XDVSH4G4.js.map
