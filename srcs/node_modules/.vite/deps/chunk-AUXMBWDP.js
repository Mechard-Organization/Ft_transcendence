...
var _WebAudioParameterComponent = class {
  ...
  setTargetValue(value, options = null) {
    ...
    const shape = typeof (options == null ? void 0 : options.shape) === "string" ? options.shape : "linear";
    ...
    let duration = typeof (options == null ? void 0 : options.duration) === "number" ? Math.max(options.duration, this._engine.parameterRampDuration) : this._engine.parameterRampDuration;
...
//# sourceMappingURL=chunk-AUXMBWDP.js.map
