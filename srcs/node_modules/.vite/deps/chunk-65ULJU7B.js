...
import {
  ...
  _CommonDispose,
  _CommonInit
} from "./chunk-XWUPGHYU.js";
import {
  _SpatialAudioAttacherComponent,
  _SpatialWebAudioUpdaterComponent
} from "./chunk-GB344CRV.js";
import {
  AbstractAudioNode,
  _WebAudioParameterComponent
} from "./chunk-AUXMBWDP.js";
import {
  AbstractMesh
} from "./chunk-VOLOM45C.js";
import {
  UniformBuffer
} from "./chunk-I4YIQPFW.js";
import {
  PerfCounter
...
import {
  Color4
} from "./chunk-TE36JXZA.js";
import {
  Tools
} from "./chunk-VN4MOBH6.js";
import {
  AbstractEngine,
  AlphaState,
  DepthCullingState,
  ...
  resetCachedPipeline
} from "./chunk-VTM2ZZ3V.js";
import {
  Matrix,
  Quaternion,
  Vector3
} from "./chunk-XFNV4A22.js";
import {
  EngineStore
} from "./chunk-ZVW3KNNR.js";
import {
  ILog2
} from "./chunk-SSQZIFEP.js";
import {
  Logger
    ...
    while (true) {
      ...
      if (!bufferInfo) {
        ...
        if (knownUBO) {
          ...
          binding = knownUBO.binding;
          if (binding.groupIndex === -1) {
            binding = (_a = this._webgpuProcessingContext.availableBuffers[name3]) == null ? void 0 : _a.binding;
            if (!binding) {
              binding = this._webgpuProcessingContext.getNextFreeUBOBinding();
            }
          }
...
var WebGPUTextureManager = class {
  ...
  generateMipmaps(gpuOrHdwTexture, mipLevelCount, faceIndex = 0, commandEncoder) {
    ...
    for (let i = 1; i < mipLevelCount; ++i) {
      const renderPassDescriptor = ((_a = webgpuHardwareTexture == null ? void 0 : webgpuHardwareTexture._mipmapGenRenderPassDescr[faceIndex]) == null ? void 0 : _a[i - 1]) ?? {
      ...
      const passEncoder = commandEncoder.beginRenderPass(renderPassDescriptor);
      const bindGroup = ((_b = webgpuHardwareTexture == null ? void 0 : webgpuHardwareTexture._mipmapGenBindGroup[faceIndex]) == null ? void 0 : _b[i - 1]) ?? this._device.createBindGroup({
        layout: bindGroupLayout,
        entries: [
          {
            binding: 0,
...
var WebGPUCacheRenderPipeline = class _WebGPUCacheRenderPipeline {
  ...
  setMRT(textureArray, textureCount) {
    ...
    for (let i = 0; i < textureCount; ++i) {
      ...
      this._mrtFormats[i] = (gpuWrapper == null ? void 0 : gpuWrapper.format) ?? this._webgpuColorFormat[0];
  ...
  _createRenderPipeline(effect, topology, sampleCount) {
    ...
    return this._device.createRenderPipeline({
      label: `RenderPipeline_${((_a = colorStates2[0]) == null ? void 0 : _a.format) ?? "nooutput"}_${this._webgpuDepthStencilFormat ?? "nodepth"}_samples${sampleCount}_textureState${this._textureState}`,
...
var WebGPUDrawContext = class _WebGPUDrawContext {
  ...
  setBuffer(name3, buffer) {
    var _a;
    this._isDirty || (this._isDirty = (buffer == null ? void 0 : buffer.uniqueId) !== ((_a = this.buffers[name3]) == null ? void 0 : _a.uniqueId));
        ...
        if (entry.sampler) {
          ...
          if (bindingInfo) {
            ...
            if (this._engine.dbgSanityChecks && (!hardwareTexture || entry.texture && !hardwareTexture.view || entry.storageTexture && !hardwareTexture.viewForWriting)) {
              Logger.Error(`Trying to bind a null gpu texture or view! entry=${JSON.stringify(entry)}, name=${name3}, bindingInfo=${JSON.stringify(bindingInfo, (key, value) => key === "texture" ? "<no dump>" : value)}, isReady=${(_e = bindingInfo.texture) == null ? void 0 : _e.isReady}, materialContext.uniqueId=${materialContext.uniqueId}`, 50);
              continue;
            }
          ...
          if (bindingInfo) {
            ...
            if (this._engine.dbgSanityChecks && !externalTexture) {
              Logger.Error(`Trying to bind a null gpu external texture! entry=${JSON.stringify(entry)}, name=${name3}, bindingInfo=${JSON.stringify(bindingInfo, (key, value) => key === "texture" ? "<no dump>" : value)}, isReady=${(_f = bindingInfo.texture) == null ? void 0 : _f.isReady}, materialContext.uniqueId=${materialContext.uniqueId}`, 50);
              continue;
            }
...
function CreateAudioBusAsync(name3, options = {}, engine = null) {
  engine = _GetAudioEngine(engine);
  return engine.createBusAsync(name3, options);
}
function CreateMainAudioBusAsync(name3, options = {}, engine = null) {
  engine = _GetAudioEngine(engine);
  return engine.createMainBusAsync(name3, options);
}
function CreateMicrophoneSoundSourceAsync(name3, options = {}, engine = null) {
  engine = _GetAudioEngine(engine);
  return engine.createMicrophoneSoundSourceAsync(name3, options);
}
function CreateSoundAsync(name3, source, options = {}, engine = null) {
  engine = _GetAudioEngine(engine);
  return engine.createSoundAsync(name3, source, options);
}
...
function CreateSoundSourceAsync(name3, source, options = {}, engine = null) {
  engine = _GetAudioEngine(engine);
  return engine.createSoundSourceAsync(name3, source, options);
}
function CreateStreamingSoundAsync(name3, source, options = {}, engine = null) {
  engine = _GetAudioEngine(engine);
  return engine.createStreamingSoundAsync(name3, source, options);
}
...
var _WebAudioMainOut = class extends _MainAudioOut {
  ...
  _setGainNode(gainNode) {
    ...
    (_a = this._gainNode) == null ? void 0 : _a.disconnect();
...
var _WebAudioUnmuteUI = class {
  ...
  constructor(engine, parentElement) {
    ...
    this._engine = engine;
    const parent = parentElement || ((_b = (_a = EngineStore.LastCreatedEngine) == null ? void 0 : _a.getInputElement()) == null ? void 0 : _b.parentElement) || document.body;
    const top = ((parent == null ? void 0 : parent.offsetTop) || 0) + 20;
...
var _WebAudioEngine = class extends AudioEngineV2 {
  ...
  constructor(options = {}) {
    ...
    this._update = () => {
      var _a;
      if ((_a = this._updateObservable) == null ? void 0 : _a.hasObservers()) {
  ...
  /** @internal */
  async createBusAsync(name3, options = {}) {
    const module = await import("./webAudioBus-YBDLUVA6.js");
    const bus = new module._WebAudioBus(name3, this, options);
    await bus._initAsync(options);
    return bus;
  }
  /** @internal */
  async createMainBusAsync(name3, options = {}) {
    const module = await import("./webAudioMainBus-B2LONZU5.js");
    const bus = new module._WebAudioMainBus(name3, this);
    await bus._initAsync(options);
    return bus;
  }
  /** @internal */
  async createMicrophoneSoundSourceAsync(name3, options) {
    let mediaStream;
    try {
    ...
    return await this.createSoundSourceAsync(name3, new MediaStreamAudioSourceNode(this._audioContext, { mediaStream }), {
      outBusAutoDefault: false,
      ...options
    });
  }
  /** @internal */
  async createSoundAsync(name3, source, options = {}) {
    const module = await import("./webAudioStaticSound-WCOS3I2Q.js");
    const sound = new module._WebAudioStaticSound(name3, this, options);
  ...
  /** @internal */
  async createSoundSourceAsync(name3, source, options = {}) {
    const module = await import("./webAudioSoundSource-56UHXTKL.js");
    const soundSource = new module._WebAudioSoundSource(name3, source, this, options);
    await soundSource._initAsync(options);
    return soundSource;
  }
  /** @internal */
  async createStreamingSoundAsync(name3, source, options = {}) {
    const module = await import("./webAudioStreamingSound-EBHHLLB4.js");
    const sound = new module._WebAudioStreamingSound(name3, this, options);
    await sound._initAsync(source, options);
    return sound;
  }
  /** @internal */
  dispose() {
    var _a, _b, _c, _d;
    super.dispose();
    (_a = this._listener) == null ? void 0 : _a.dispose();
    this._listener = null;
    ...
    (_b = this._silentHtmlAudio) == null ? void 0 : _b.remove();
    (_c = this._updateObservable) == null ? void 0 : _c.clear();
    this._updateObservable = null;
    (_d = this._unmuteUI) == null ? void 0 : _d.dispose();
    this._unmuteUI = null;
...
var AudioEngine = class {
  ...
  constructor(hostElement = null, audioContext = null, audioDestination = null) {
    ...
    const v2 = new _WebAudioEngine({
      ...
      defaultUIParentElement: (hostElement == null ? void 0 : hostElement.parentElement) ? hostElement.parentElement : void 0
    });
  ...
  unlock() {
    var _a;
    if (((_a = this._v2._audioContext) == null ? void 0 : _a.state) === "running") {
      if (!this.unlocked) {
        this.unlocked = true;
        this.onAudioUnlockedObservable.notifyObservers(this);
      }
  ...
  _resumeAudioContextOnStateChange() {
    var _a;
    (_a = this._v2._audioContext) == null ? void 0 : _a.addEventListener("statechange", () => {
      var _a2;
      if (this.unlocked && ((_a2 = this._v2._audioContext) == null ? void 0 : _a2.state) !== "running") {
...
ThinWebGPUEngine.prototype.updateRenderTargetTextureSampleCount = function(rtWrapper, samples) {
  ...
  gpuTexture == null ? void 0 : gpuTexture.releaseMSAATextures();
  if (rtWrapper._depthStencilTexture) {
    (_a = rtWrapper._depthStencilTexture._hardwareTexture) == null ? void 0 : _a.releaseMSAATextures();
...
var WebGPUEngine = class _WebGPUEngine extends ThinWebGPUEngine {
  ...
  prepareGlslangAndTintAsync() {
    if (!this._workingGlslangAndTintPromise) {
      this._workingGlslangAndTintPromise = new Promise((resolve) => {
        var _a;
        this._initGlslangAsync(this._glslangOptions ?? ((_a = this._options) == null ? void 0 : _a.glslangOptions)).then((glslang) => {
          var _a2;
  ...
  initAsync(glslangOptions, twgslOptions) {
    ...
    return navigator.gpu.requestAdapter(this._options).then(async (adapter) => {
      ...
      if (!adapter) {
        ...
        (_a = this._adapter.features) == null ? void 0 : _a.forEach((feature) => {
      ...
      (_a = this._device.features) == null ? void 0 : _a.forEach((feature) => {
  ...
  _startRenderTargetRenderPass(renderTargetWrapper, setClearStates, clearColor, clearDepth, clearStencil) {
    ...
    let format;
    if (useMSAA) {
      const gpuMSAATexture = gpuDepthStencilWrapper == null ? void 0 : gpuDepthStencilWrapper.getMSAATexture(sampleCount);
      depthStencilView = gpuMSAATexture == null ? void 0 : gpuMSAATexture.createView(this._rttRenderPassWrapper.depthAttachmentViewDescriptor);
      format = gpuMSAATexture == null ? void 0 : gpuMSAATexture.format;
    }
    ...
    if (rtWrapper._attachments && rtWrapper.isMulti) {
      ...
      for (let i = 0; i < this._mrtAttachments.length; ++i) {
        ...
        if (gpuMRTWrapper && gpuMRTTexture) {
          ...
          const gpuMSAATexture = useMSAA ? gpuMRTWrapper.getMSAATexture(sampleCount, i) : void 0;
      ...
      if (internalTexture) {
        ...
        const gpuMSAATexture = useMSAA ? gpuWrapper.getMSAATexture(sampleCount) : void 0;
    ...
    this._rttRenderPassWrapper.renderPassDescriptor = {
      ...
      occlusionQuerySet: ((_b = this._occlusionQuery) == null ? void 0 : _b.hasQueries) ? this._occlusionQuery.querySet : void 0
    };
  ...
  setTextureSampler(name3, sampler) {
    var _a;
    (_a = this._currentMaterialContext) == null ? void 0 : _a.setSampler(name3, sampler);
  }
  //------------------------------------------------------------------------------
  //                              Storage Buffers
  //------------------------------------------------------------------------------
  ...
  setStorageBuffer(name3, buffer) {
    var _a;
    (_a = this._currentDrawContext) == null ? void 0 : _a.setBuffer(name3, (buffer == null ? void 0 : buffer.getBuffer()) ?? null);
  }
};
...
WebGPUEngine.prototype.createMultipleRenderTarget = function(size, options, initializeBuffers) {
  ...
  rtWrapper.label = (options == null ? void 0 : options.label) ?? "MultiRenderTargetWrapper";
...
WebGPUEngine.prototype.updateMultipleRenderTargetTextureSampleCount = function(rtWrapper, samples) {
  ...
  for (let i = 0; i < count; ++i) {
    ...
    const gpuTextureWrapper = texture._hardwareTexture;
    gpuTextureWrapper == null ? void 0 : gpuTextureWrapper.releaseMSAATextures();
  }
  for (let i = 0; i < count; ++i) {
    const texture = rtWrapper.textures[i];
...
//# sourceMappingURL=chunk-65ULJU7B.js.map
