...
import { PPContent } from "../content/PrivacyPolicy";
  ...
  return (
    ...
    <main id="mainContent">
      <div className="min-h-[calc(100vh-8rem)] max-w-2xl w-full  mx-auto text-center">
              <br/><br/>
        <div className="bg-white/90 backdrop-blur-sm rounded-3xl overflow-y-auto p-5 h-175 shadow-xl hover:shadow-3xl sm:flex-row border-4 border-[#FEE96E] cursor-pointer">
